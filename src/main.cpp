...
// make surcloning.scrypt.altcoine all wallets know about the given transaction, in the given block
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // niccoin: 0.35 days
static const int64 nTargetSpacing = 15; // niccoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal niccoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "niccoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x07e2571fdfd7bac64ed59c8336e960514ed9008bc45b06e64501c1b1965988dd");
    }
    ...
    // block.GetHash = aa9124ab9258eeb590cc1bb962494fbae643c6428824ee761854b8afa5333744
    // CBlock(hash=aa9124ab9258eeb590cc, PoW=00000706d9c5c45306e2, ver=1,
